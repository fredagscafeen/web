...
class BartenderAdmin(DjangoObjectActions, ModelAdmin):
...
class BartenderApplicationAdmin(DjangoObjectActions, ModelAdmin):
...
class BartenderShiftAdmin(ModelAdmin):
...
class ReleasedBartenderShiftAdmin(ModelAdmin):
    list_display = ("bartender", "bartender_shift")


@admin.register(BoardMemberDepositShift)
class BoardMemberDepositShiftAdmin(ModelAdmin):
...
class BoardMemberPeriodAdmin(ModelAdmin):
    inlines = [BoardMemberInline]


@admin.register(BartenderShiftPeriod)
class BartenderShiftPeriodAdmin(ModelAdmin):

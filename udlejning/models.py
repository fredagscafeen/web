...
class Udlejning(models.Model):
	...
	association = models.CharField(max_length=16, choices=ASSOCIATION_CHOICES, null=True)
	draftBeerSystem = models.CharField(max_length=16, choices=SYSTEM_CHOICES, null=True)

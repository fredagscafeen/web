...
class IncomingMailAdmin(DjangoObjectActions, ModelAdmin):
    list_display = (
        "get_status_display",
        "get_subject_display",
        "mailing_list",
...
class ForwardedMailAdmin(DjangoObjectActions, ModelAdmin):
    list_display = (
        "incoming_mail",
        "target",
        "status",
...
class OutgoingEmailAdmin(DjangoObjectActions, ModelAdmin):
    list_display = [
        "subject_display",
...
class SpamFilterTLDAdmin(ModelAdmin):
    list_display = (
        "allowed",
        "tld",
        "description",

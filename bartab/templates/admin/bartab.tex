...
\noindent
{\Large\textbf{% templatetag openbrace %}Nye kunder{% templatetag closebrace %}}
\vspace{0.5cm}

\noindent
For at blive kunde, skal man:
\begin{itemize}
	\item Godkendes af den ansvarlige bartender (Spørge pænt).
	\item Komme ofte nok i baren, til at det kan betale sig at have en tab.
	\item Sætte penge ind på taben med det samme.
\end{itemize}

\noindent
\textit{BEMÆRK: Skriv \textbf{Navn} og \textbf{Email} tydeligt i felterne nedenfor.}
\begin{longtabu} to \linewidth{| X[2, c] | X[4, l] | X[25, l] | X[25, l] | X[21, l] |}
\taburowcolors {white .. gray!50}
\hline
\krcoins & \textbf{Indsat} & \textbf{Navn} & \textbf{Email} (Ikke en uni mail) & \textbf{Køb} \hfill \\ \hline
\endhead
&&  &  &  \\ \hline
&&  &  &  \\ \hline
&&  &  &  \\ \hline
